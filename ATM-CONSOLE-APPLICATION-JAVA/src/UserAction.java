...
public void withdraw(User customer, Scanner sc) throws CloneNotSupportedException {
    ...
    while (amount != 0) {
        ...
        for (Notes note : ATM.getNotesArrayList().getAllNoteList()) {  // Iterate directly on ATM inventory
    ...
    @Override
    public void deposit(User user, NotesList<Notes> cashInventory,CommonAction commonAction, Scanner sc) {
