...
public class CommonAction implements CommonActionInterface{
    @Override
     public Account userLogin(ArrayList<Account> accounts, Scanner sc) { // Method user login
    ...
    @Override
    public void addToCashInventory(NotesList<Notes> cashInventory, Notes newNote) { // method to add money to inventory
